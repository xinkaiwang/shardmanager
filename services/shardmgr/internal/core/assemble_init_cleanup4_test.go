	...
	fn := func() {
		...
		worker2FullId := data.WorkerFullIdParseFromString("smgapp-6d9cfc6cdd-t7mqx:KV57TEHC")
		{
			...
			setup.ModifyWorkerState(ctx, worker1FullId, func(wej *smgjson.WorkerStateJson) *smgjson.WorkerStateJson {
				return smgjson.WorkerStateJsonFromJson(`{"worker_id":"smgapp-6d9cfc6cdd-b9whq","session_id":"6X30CVPL","worker_info":{"address_port":"10.108.1.151:8080","start_time_ms":1748392249064,"capacity":1000,"memory_size_mb":0},"worker_state":"online_healthy","asgs":{"7DTBC24R":{"sid":"shard_80_c0","rid":1,"cur":"ready","tgt":"ready","rt":1},"DV9WK3DJ":{"sid":"shard_80_c0","cur":"dropped","tgt":"ready","rt":1},"F7Z2D89Z":{"sid":"shard_40_80","rid":1,"cur":"ready","tgt":"ready","rt":1},"ROCQ8S56":{"sid":"shard_c0_00","cur":"dropped","tgt":"ready","rt":1}},"update_time_ms":1234500000000,"update_reason":"WorkerInfo","stateful_type":"state_in_mem"}`)
			})
			setup.ModifyPilotNode(ctx, worker1FullId, func(pnj *cougarjson.PilotNodeJson) *cougarjson.PilotNodeJson {
				return cougarjson.ParsePilotNodeJson(`{"worker_id":"smgapp-6d9cfc6cdd-b9whq","session_id":"6X30CVPL","asgs":[{"shd":"shard_80_c0","idx":1,"asg":"7DTBC24R","sts":"ready"},{"shd":"shard_40_80","idx":1,"asg":"F7Z2D89Z","sts":"ready"}],"update_time_ms":1748481151040,"update_reason":"updateAssign:1K5CSS5K:ready"}`)
			})
			setup.ModifyRoutingEntry(ctx, worker1FullId, func(rj *unicornjson.WorkerEntryJson) *unicornjson.WorkerEntryJson {
				return unicornjson.WorkerEntryJsonFromJson(`{"worker_id":"smgapp-6d9cfc6cdd-b9whq","session_id":"6X30CVPL","addr_port":"10.108.1.151:8080","asgs":[{"shd":"shard_80_c0","idx":4,"asg":"1K5CSS5K"},{"shd":"shard_80_c0","idx":1,"asg":"7DTBC24R"},{"shd":"shard_40_80","idx":3,"asg":"G3YR6XMX"},{"shd":"shard_40_80","idx":1,"asg":"F7Z2D89Z"},{"shd":"shard_00_40","idx":3,"asg":"O943MMQP"},{"shd":"shard_c0_00","asg":"ROCQ8S56"},{"shd":"shard_40_80","idx":2,"asg":"VXU99ZAZ"},{"shd":"shard_40_80","idx":4,"asg":"S1VB4C72"},{"shd":"shard_80_c0","idx":2,"asg":"DRGNL5RL"},{"shd":"shard_80_c0","asg":"DV9WK3DJ"}],"update_time_ms":1748481151040,"update_reason":"addToRouting"}`)
			})
			setup.ModifyWorkerState(ctx, worker2FullId, func(wej *smgjson.WorkerStateJson) *smgjson.WorkerStateJson {
				return smgjson.WorkerStateJsonFromJson(`{"worker_id":"smgapp-6d9cfc6cdd-t7mqx","session_id":"KV57TEHC","worker_state":"online_healthy","asgs":{"7VLPERL7":{"sid":"shard_00_40","rid":1,"cur":"ready","tgt":"ready","rt":1},"CO8E9IXV":{"sid":"shard_c0_00","rid":1,"cur":"ready","tgt":"ready","rt":1},"D68K3VQ1":{"sid":"shard_40_80","cur":"dropped","tgt":"ready","rt":1},"NFQFZQZL":{"sid":"shard_00_40","cur":"dropped","tgt":"ready","rt":1}},"update_time_ms":1748481145042,"update_reason":"addToRouting","stateful_type":"state_in_mem"}`)
			})
			setup.ModifyPilotNode(ctx, worker2FullId, func(pnj *cougarjson.PilotNodeJson) *cougarjson.PilotNodeJson {
				return cougarjson.ParsePilotNodeJson(`{"worker_id":"smgapp-6d9cfc6cdd-t7mqx","session_id":"KV57TEHC","asgs":[{"shd":"shard_00_40","idx":1,"asg":"7VLPERL7","sts":"ready"},{"shd":"shard_c0_00","idx":1,"asg":"CO8E9IXV","sts":"ready"}],"update_time_ms":1748481145041,"update_reason":"updateAssign:UVZMJNN4:ready"}`)
			})
			setup.ModifyRoutingEntry(ctx, worker2FullId, func(rj *unicornjson.WorkerEntryJson) *unicornjson.WorkerEntryJson {
				return unicornjson.WorkerEntryJsonFromJson(`{"worker_id":"smgapp-6d9cfc6cdd-t7mqx","session_id":"KV57TEHC","addr_port":"10.108.1.239:8080","asgs":[{"shd":"shard_80_c0","idx":3,"asg":"Z70GLRV1"},{"shd":"shard_c0_00","idx":3,"asg":"0N3BMAOX"},{"shd":"shard_00_40","idx":1,"asg":"7VLPERL7"},{"shd":"shard_c0_00","idx":1,"asg":"CO8E9IXV"},{"shd":"shard_40_80","asg":"D68K3VQ1"},{"shd":"shard_00_40","idx":4,"asg":"E41NKQUT"},{"shd":"shard_c0_00","idx":4,"asg":"UVZMJNN4"},{"shd":"shard_c0_00","idx":2,"asg":"A2ADCRWC"},{"shd":"shard_00_40","idx":2,"asg":"M5BYI6QP"},{"shd":"shard_00_40","asg":"NFQFZQZL"}],"update_time_ms":1748481145042,"update_reason":"addToRouting"}`)
			})
