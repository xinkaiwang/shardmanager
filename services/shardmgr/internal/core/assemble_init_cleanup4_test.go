	...
	fn := func() {
		...
		worker2FullId := data.WorkerFullIdParseFromString("smgapp-6d9cfc6cdd-t7mqx:KV57TEHC")
		{
			...
			setup.ModifyWorkerState(ctx, worker1FullId, func(wej *smgjson.WorkerStateJson) *smgjson.WorkerStateJson {
				return smgjson.WorkerStateJsonFromJson(`{"worker_id":"smgapp-6d9cfc6cdd-b9whq","session_id":"6X30CVPL","worker_info":{"address_port":"10.108.1.151:8080","start_time_ms":1748392249064,"capacity":1000,"memory_size_mb":0},"worker_state":"online_healthy","assignments":{"7DTBC24R":{"sid":"shard_80_c0","rid":1,"current_state":"ready","target_state":"ready","in_routing":1},"DV9WK3DJ":{"sid":"shard_80_c0","current_state":"dropped","target_state":"ready","in_routing":1},"F7Z2D89Z":{"sid":"shard_40_80","rid":1,"current_state":"ready","target_state":"ready","in_routing":1},"ROCQ8S56":{"sid":"shard_c0_00","current_state":"dropped","target_state":"ready","in_routing":1}},"update_time_ms":1234500000000,"update_reason":"WorkerInfo","stateful_type":"state_in_mem"}`)
			})
			setup.ModifyPilotNode(ctx, worker1FullId, func(pnj *cougarjson.PilotNodeJson) *cougarjson.PilotNodeJson {
				return cougarjson.ParsePilotNodeJson(`{"worker_id":"smgapp-6d9cfc6cdd-b9whq","session_id":"6X30CVPL","assignments":[{"shd":"shard_80_c0","idx":1,"asg":"7DTBC24R","sts":"ready"},{"shd":"shard_40_80","idx":1,"asg":"F7Z2D89Z","sts":"ready"}],"update_time_ms":1748481151040,"update_reason":"updateAssign:1K5CSS5K:ready"}`)
			})
			...
			setup.ModifyWorkerState(ctx, worker2FullId, func(wej *smgjson.WorkerStateJson) *smgjson.WorkerStateJson {
				return smgjson.WorkerStateJsonFromJson(`{"worker_id":"smgapp-6d9cfc6cdd-t7mqx","session_id":"KV57TEHC","worker_state":"online_healthy","assignments":{"7VLPERL7":{"sid":"shard_00_40","rid":1,"current_state":"ready","target_state":"ready","in_routing":1},"CO8E9IXV":{"sid":"shard_c0_00","rid":1,"current_state":"ready","target_state":"ready","in_routing":1},"D68K3VQ1":{"sid":"shard_40_80","current_state":"dropped","target_state":"ready","in_routing":1},"NFQFZQZL":{"sid":"shard_00_40","current_state":"dropped","target_state":"ready","in_routing":1}},"update_time_ms":1748481145042,"update_reason":"addToRouting","stateful_type":"state_in_mem"}`)
			})
			setup.ModifyPilotNode(ctx, worker2FullId, func(pnj *cougarjson.PilotNodeJson) *cougarjson.PilotNodeJson {
				return cougarjson.ParsePilotNodeJson(`{"worker_id":"smgapp-6d9cfc6cdd-t7mqx","session_id":"KV57TEHC","assignments":[{"shd":"shard_00_40","idx":1,"asg":"7VLPERL7","sts":"ready"},{"shd":"shard_c0_00","idx":1,"asg":"CO8E9IXV","sts":"ready"}],"update_time_ms":1748481145041,"update_reason":"updateAssign:UVZMJNN4:ready"}`)
			})
